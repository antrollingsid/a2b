...
class AppColors {
  static const Color onBackgroundDark = Color.fromRGBO(223, 219, 216, 1);
  static const Color onBackgroundLight = Color.fromRGBO(18, 18, 18, 1.0);

  static const Color secondaryDark = Color.fromRGBO(96, 191, 244, 1);
  static const Color secondaryLight = Color.fromRGBO(44, 102, 110, 1.0);
  ...
  static const Color primaryDark = Color.fromRGBO(187, 134, 252, 1.0);
  static const Color primaryLight = Color.fromRGBO(214, 117, 91, 1);

  static const Color buttonDark = Color.fromRGBO(23, 23, 23, 1.0);

  static const Color backgroundDark = Color.fromRGBO(18, 18, 18, 1.0);
  static const Color backgroundLight = Color.fromRGBO(223, 219, 216, 1);
  ...
  static const Color textGrey = Color.fromRGBO(125, 125, 125, 1.0);

  static const Color textBlue = Color.fromRGBO(17, 63, 118, 1.0);
  static const accent = Color.fromRGBO(214, 117, 91, 1);
